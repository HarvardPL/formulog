...
public enum BuiltInConstructorSymbolBase implements FunctorBase {
	...
	SMT_FORALL_PAT("smt_forall_pat", 3, ParamKind.SMT_VARS, ParamKind.SMT_QUANTIFIER_PAT),
	
	SMT_EXISTS_PAT("smt_exists_pat", 3, ParamKind.SMT_VARS, ParamKind.SMT_QUANTIFIER_PAT),
