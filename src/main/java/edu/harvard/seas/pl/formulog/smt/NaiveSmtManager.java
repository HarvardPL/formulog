...
public class NaiveSmtManager extends AbstractSmtManager {

	private final NoCachingSolver solver = new NoCachingSolver(); 
	
	public NaiveSmtManager(Program<UserPredicate, BasicRule> prog) {
		solver.start(prog);
	}
