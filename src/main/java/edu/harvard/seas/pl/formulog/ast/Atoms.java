...
//	}
//
//	public static interface Atom<R extends RelationSymbol> extends Conjunct<R> {
//
//		R getSymbol();
//
//		Term[] getArgs();
...
//	public static Atom get(RelationSymbol sym, Term[] args, boolean neg) {
...
//
//		protected NormalAtom(RelationSymbol sym, Term[] args, boolean neg) {
//			this.sym = sym;
//			this.args = args;
//			this.neg = neg;
//		}
...
//	}
//	
//	public static <R extends RelationSymbol> Atom<R> liftTerm(Term t, boolean negated) {
