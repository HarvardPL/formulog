...
public class IndexedFactSet {

	private final Atom canonicalAtom;
	private final IndexEntry[] idxs;
	private final Map<Object, Object> map = new ConcurrentHashMap<>();

	public IndexedFactSet(NormalAtom q, Set<Var> boundVars) {
	...
	public void query(Map<Object, Object> m, Substitution s, int idx, Collection<Iterable<NormalAtom>> acc)
	...
	public IndexEntry[] createIndex(Set<IndexEntry> idxSet, Set<Var> initBoundVar) {
