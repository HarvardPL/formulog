...
public class LiteralCodeGen {
	 ...
	 * 
	 * @param the
	 *            relations which should be accessed with hints
	 */
	 ...
	 *            The predicate
	 * @param index
	 *            Database index to use for lookup
	 * @param parallelize
	...
	private class Worker {
		 ...
		 * 
		 * @param pred
		 *            The predicate that is being encoded
		 ...
		 * 
		 * @param pred
		 *            The predicate corresponding to the relation that is being looped
		 *            over
		 ...
		 * 
		 * @param pred
		 *            The predicate that corresponds to the lookup
		 ...
		 *            The predicate
		 * @param it
		 *            The tuple iterator to loop over
