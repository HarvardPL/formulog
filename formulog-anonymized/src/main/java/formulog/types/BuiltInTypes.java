...
import static formulog.symbols.BuiltInConstructorSymbol.CMP_EQ;
import static formulog.symbols.BuiltInConstructorSymbol.CMP_GT;
import static formulog.symbols.BuiltInConstructorSymbol.CMP_LT;
import static formulog.symbols.BuiltInConstructorSymbol.CONS;
import static formulog.symbols.BuiltInConstructorSymbol.NIL;
import static formulog.symbols.BuiltInConstructorSymbol.NONE;
import static formulog.symbols.BuiltInConstructorSymbol.SOME;
import static formulog.symbols.BuiltInTypeSymbol.ARRAY_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.BOOL_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.BV;
import static formulog.symbols.BuiltInTypeSymbol.CMP_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.FP;
import static formulog.symbols.BuiltInTypeSymbol.INT_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.LIST_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.MODEL_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.OPTION_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.SMT_PATTERN_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.SMT_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.SMT_WRAPPED_VAR_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.STRING_TYPE;
import static formulog.symbols.BuiltInTypeSymbol.SYM_TYPE;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import formulog.symbols.BuiltInConstructorGetterSymbol;
